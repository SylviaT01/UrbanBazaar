              ...
              <div className="overflow-x-auto">
                <table className="min-w-full divide-gray-200">
                  ...
                  <tfoot>
                    <tr>
                      <td colSpan="5" className="px-4 py-2 text-right text-sm font-bold text-gray-700">Total:</td>
                      <td colSpan="2" className="px-4 py-2 text-sm font-bold text-gray-700 bg-gray-100">Kshs. {Math.round(totalPayment)}</td>
                    </tr>
                  </tfoot>
                </table>
              </div>
              ...
              {currentPayments.map((payment, index) => (
                <div className="flex flex-col bg-white p-4 mb-4 rounded-lg shadow" key={payment.id}>
                  <div className="flex flex-col">
                    ...
                    <div className="text-sm text-gray-600 mb-2">Kshs. {Math.round(payment.order_total)}</div>
