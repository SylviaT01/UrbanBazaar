            ...
            {currentOrders.length ? (
              currentOrders.map((order) => (
                <div key={order.id} className="border-b p-4 flex flex-col space-y-2">
                  ...
                  <div className="flex flex-col">
                    <span className="font-semibold text-sm text-gray-600">Shipping Address: </span>
                    <span className="text-sm text-gray-600 mb-2">{order.shipping_address}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-semibold text-sm text-gray-600">Payment Method: </span>
                    <span className="text-sm text-gray-600 mb-2">{order.payment_method}</span>
                  </div>
                  <div className="flex flex-col">
                    <span className="font-semibold text-sm text-gray-600">Amount: </span>
                    <span className="text-sm text-gray-600 mb-2">Ksh {order.order_total}</span>
                  </div>
                  <div className="flex flex-col">
