              ...
              {wishlist.length === 0 ? (
                ...
                <div>
                  ...
                  <div className="block md:hidden">
                    {wishlist.map((item, i) => (
                      <div key={i} className="bg-white border rounded-md shadow-sm mb-4 p-4">
                        <div className="flex items-center mb-3">
                          ...
                          <div>
                            <h4 className="text-sm font-medium">{item.title}</h4>
                            <p className="text-gray-600">Ksh {Math.round((item.price * (100 - item.discount_percentage)) / 100).toLocaleString()}</p>
                          </div>
                        </div>
                        <button
                          className="text-red-600 hover:text-red-800"
