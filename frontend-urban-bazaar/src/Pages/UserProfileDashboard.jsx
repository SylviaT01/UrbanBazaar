...
const UserProfile = () => {
  ...
  return (
    <div className="flex min-h-screen bg-[#F0F9FF] py-20">
      {/* Sidebar */}
      <aside className="ml-20 w-64 text-[#747474] bg-white shadow-md">
        <div className="p-4">
          {/* User Profile */}
          <div className="flex items-center mb-4 border-b-2 border-gray-200">
            <img src={userimage} alt="User Profile" className="rounded-full w-24 h-24 mr-2" />
          ...
          <nav>
            <ul>
              <li className="mb-4">
                ...
                >
                  <img src={userdashboard} className="mr-3" alt="User Dashboard" />
                  Dashboard
                </NavLink>
              </li>
              <li className="mb-4">
                ...
                >
                  <img src={orderhistory} className="mr-3" alt="Order History" />
                  Order History
                </NavLink>
              </li>
              <li className="mb-4">
              ...
              <li className="mb-4">
                ...
                >
                  <img src={userprofile} className="mr-3" alt="Update Profile" />
                  Update Profile
                </NavLink>
              </li>
              <li className="mb-4">
