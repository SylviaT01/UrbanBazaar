...
//                     const uniqueCategoryProducts = Array.from(categoryMap.values()).slice(0, 5); 
//                     const categoryImages = uniqueCategoryProducts.map(product => ({
//                         category: product.category,
//                         imageUrl: product.images[0] // Assuming the first image represents the category
//                     }));
...
//             {/* Category Cards */}
//             <div className="absolute bottom-[-70%] left-0 w-full flex justify-center bg-transparent">
